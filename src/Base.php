<?php
	...
	use Compleeted\Support\Ary;
	use Compleeted\Support\Str;
	use Redis;

	abstract class Base
	{
		use Support\Traits\RedisConnectionManager;

		/**
		 *
		 * Compleeted version string.
		 *
		 * @var string
		 *
		 */
		...
		/**
		 *
		 * Minimum amount of chars to consider autocompletion.
		 *
		 * @var int
		 *
		 */
		protected $minComplete = 1;
		 ...
		 *
		 */
		protected $indexName = 'compleeted-index';
		 ...
		 *
		 */
		protected $dataIndexName = 'compleeted-data';
		 ...
		 *
		 */
		protected $cacheIndexName = 'compleeted-cache';
		...
		{
			return $this->getCacheIndexName() . ':' . $this->getType();
		}
	}
